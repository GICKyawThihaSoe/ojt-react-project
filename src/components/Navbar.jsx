...
// Higher Order Component (HOC) for handling responsiveness
const withResponsiveNavbar = (WrappedComponent) => {
...
const Navbar = ({ isMobileMenuOpen, toggleMobileMenu }) => {
  return (
    <>
      <header className="mt-10 ml-20 mx-20">
        <div className="flex justify-between items-center">
          ...
          <button
            type="button"
            className="text-gray-900 block sm:hidden hover:text-gray-400"
          ...
          <ul className={`sm:flex ${isMobileMenuOpen ? "block" : "hidden"}`}>
            <li>
              <a
                href="#"
                className="capitalize hover:text-gray-400 mr-5 text-black font-medium"
              >
                pricing
              </a>
            </li>
...
// Wrap the Navbar component with the HOC
const ResponsiveNavbar = withResponsiveNavbar(Navbar);
