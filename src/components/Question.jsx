...
import { openScore } from "../feature/checkAnswerSlice";
...
const Question = () => {
  ...
  return (
    <>
      {isCheck && <ScoreModal allQuestions={Data} fetchDatas={fetchDatas} />}
      {loading ? (
        <div className="flex justify-center items-center min-h-screen">
          <div role="status">
            <svg
              aria-hidden="true"
              className="inline w-16 h-16 mr-2 text-gray2 animate-spin fill-blue"
              viewBox="0 0 100 101"
              fill="none"
