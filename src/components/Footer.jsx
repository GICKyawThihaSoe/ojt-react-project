...
const Footer = () => {
  return (
    <footer className="bg-black py-20 px-32">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="flex items-center mt-20">
            <div className="mr-3 cursor-pointer fill-white hover:fill-orange-600">
            ...
            <div className="cursor-pointer fill-white hover:fill-orange-600">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
                <path
                  fill="fill-current"
        ...
        <div>
          <ul>
            <li className="text-white capitalize mb-3 cursor-pointer hover:text-orange-500">
              home
            </li>
            <li className="text-white capitalize mb-3 cursor-pointer hover:text-orange-500">
              pricing
            ...
            <li className="text-white capitalize cursor-pointer hover:text-orange-500">
              about us
            </li>
          </ul>
        </div>
        <div>
          <ul>
            <li className="text-white capitalize mb-3 hover:text-orange-500 cursor-pointer">
              careers
            </li>
            <li className="text-white capitalize mb-3 hover:text-orange-500 cursor-pointer">
              community
            </li>
            <li className="text-white capitalize hover:text-orange-500 cursor-pointer">
              privacy policy
            </li>
          </ul>
        </div>
        <div className="flex items-center">
          <input
            ...
            className="border rounded-full p-3 w-72 outline-none"
          />
          <div className="ml-3">
            <button className="capitalize bg-orange-700 hover:bg-orange-600 text-white px-5 py-2 font-medium rounded-full">
              go
            </button>
          </div>
        </div>
      </div>
      <p className="text-white text-right">Copyright 20203.All Rights Reserved</p>
    </footer>
  );
};
